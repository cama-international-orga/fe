...
export const fileInputBox = style({
  ...
  "@media": {
    "(max-width: 767px)": { padding: "14px 0 10px 0" },
    "(min-width: 1440px)": { padding: "20px 0 14px 0", borderRadius: "12px" },
    "(min-width: 1920px)": { padding: "24px 0 16px 0" },
    "(min-width: 2560px)": { padding: "28px 0 20px 0", borderRadius: "14px" },
  },
});
